...
pub fn x86_64_abi() -> SyscallABI {
    // Fill in the x86_64 syscall ABI
...
pub fn aarch64_abi() -> SyscallABI {
    // Fill in the aarch64 syscall ABI
...
pub unsafe fn syscall3(id: usize, arg0: usize, arg1: usize, arg2: usize) -> isize {
    // Implement x86_64 syscall using core::arch::asm!
    // Hints:
    //   - "syscall" instruction
...
pub fn sys_write(fd: usize, buf: &[u8]) -> isize {
    // Call syscall3 to implement write
    unsafe {
...
pub fn sys_read(fd: usize, buf: &mut [u8]) -> isize {
    // Call syscall3 to implement read
    unsafe {
...
pub fn sys_close(fd: usize) -> isize {
    // Call syscall3 to implement close
    unsafe {
...
pub fn sys_exit(code: i32) -> ! {
    // Call syscall3 to implement exit
    unsafe {
